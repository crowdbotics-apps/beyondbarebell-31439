...
## Project Structure
    ...
    ├── beyondbarebell_31439  # Django project configurations
...
1. Clone this repo and `cd beyondbarebell_31439`
...
2. Clone this repo and `cd beyondbarebell_31439`
